...
class Game:
    def __init__(self):
        ...
        self.display = pg.Surface((320, 240), pg.SRCALPHA)
        ...
        self.sfx = {
            'jump': pg.mixer.Sound('sfx/jump.wav'),
            'dash': pg.mixer.Sound('sfx/dash.wav'),
            'hit': pg.mixer.Sound('sfx/hit.wav'),
            'shoot': pg.mixer.Sound('sfx/shoot.wav'),
            'ambience': pg.mixer.Sound('sfx/ambience.wav'),
        }
